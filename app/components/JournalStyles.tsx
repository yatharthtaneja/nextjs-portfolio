// All styles for the 3D book journal cards on the home page.
// Kept separate from CaseStudyJournal.tsx so the component file stays focused
// on JSX + interaction logic.

export default function JournalStyles() {
  return (
    <style>{`
